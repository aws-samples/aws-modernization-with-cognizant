...
aws cloudformation create-stack --stack-name Cognizant-Workshop --template-body file://cloudfront-s3-website.yaml
```
...
```
### DO NOT FORGET TO CHANGE THE STACK NAME
aws cloudformation create-stack --stack-name Cognizant-Website-Pipeline --template-body file://pipeline.yaml --capabilities CAPABILITY_NAMED_IAM
```
